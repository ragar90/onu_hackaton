OnuHackaton::Application.routes.draw do
  ...
  namespace :api do
    ...
    post 'process_payment/:type/from/:user_id/to/:client_id/of/:amount' => 'mobile_app#process_payment_for_cedit', :as=>:payment
    get "service_clients" => "mobile_app#service_clients"
  end
